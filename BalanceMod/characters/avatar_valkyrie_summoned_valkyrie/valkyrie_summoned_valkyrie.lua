-- chunkname: @characters/avatar_valkyrie_summoned_valkyrie/valkyrie_summoned_valkyrie.lua
...
local t = SettingsAux.override_settings("characters/avatar_valkyrie/valkyrie", {
	...
	shadow_blob = "nil",
	weapon_path = "characters/avatar_valkyrie_summoned_valkyrie/wep_summoned_valkyrie",
	resistances = {
		all = "immune",
	},
	scale_info = {
